...
<body>
<ul>
<li><a  href="user_CPF.php"><p class="title">Home</p></a></li>
...
{
?>
<img src="rstudio\dy.png" width="800" height="443"><br>
<?php
}
else if ($query == 2)
{
?>
<img src="rstudio\sies.png" width="800" height="443"><br>
<?php
}
else if ($query == 3)
{
?>
<img src="rstudio\pcoe.png" width="800" height="443"><br>
<?php
}
else if ($query == 4)
{
?>
<img src="rstudio\dmcoe.png" width="800" height="443"><br>
<?php
}
else if ($query == 5)
{
?>
<img src="rstudio\tcoe.png" width="800" height="443"><br>
<?php
}
else if ($query == 6)
{
?>
<img src="rstudio\igcoe.png" width="800" height="443"><br>
<?php
}
else if ($query ==7)
{
?>
<img src="rstudio\ltt.png" width="800" height="443"><br>
<?php
}
else { }
?>
