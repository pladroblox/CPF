...
<li><a href="click_here.php"><p class="title">Career</p></a></li>
...
<p class="title">College predictor</p><br>
<button class="button "><a href="college_predictor.php"><p class="title">Go</p></button>
</div>
...
<p class="title">Rank and Rating</p><br>
<button class="button"><a href="rank_rate.php"><p class="title">Go</p></button>
</div>
...
<p class="title">Trend meter</p><br>
<button class="button"><a href="trend.php"><p class="title">Go</p></button>
</div>
