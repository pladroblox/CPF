...
<br>
<br>
<center><p class="log"><b>Your data is inserted succesfully......</b></p></center>
...
<button class="buttonlog"><a href="insert_data.php"><p class="log"><b>Add more data</b></p></button>

<div class="container" style="background-color:"#ed6b2f">
    <button type="button" class="cancelbtn"><a href="CPF.php"><p class="log"><b>SIGNOUT</b></p></button>  
